package
{
	...
	public class MyTextField extends TextField
	{
		...
		public function MyTextField (_x: Number, _y: Number, _text: String, _color: uint = 0x000000, _align: String = TextFieldAutoSize.CENTER, textSize: Number = 16, _fontName: String = null)
		{
			x = _x;
			y = _y;
